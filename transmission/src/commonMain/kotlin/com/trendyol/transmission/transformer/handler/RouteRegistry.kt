...
internal class RouteRegistry<T : Transmission> {
    ...
    @PublishedApi
    internal fun register(routeKey: TransmissionRouteKey, lambda: TransmissionLambda<T>) {
    ...
    @PublishedApi
    internal fun extend(routeKey: TransmissionRouteKey, lambda: TransmissionLambda<T>) {
